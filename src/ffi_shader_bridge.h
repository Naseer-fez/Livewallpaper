...
public:
    ...
    HRESULT InitShaderHost(ID3D11Device* device, ID3D11DeviceContext* context, const std::wstring& path, wchar_t* out_error_buffer, unsigned int error_buffer_len, void** host_out);
...
private:
    ...
    typedef HRESULT(WINAPI *InitShaderHostFn)(void* device, void* context, const wchar_t* path, wchar_t* out_error_buffer, unsigned int error_buffer_len, void** out_host);
