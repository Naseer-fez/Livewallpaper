...
You are the E2E Test Implementer. Your working directory is d:\CODE\Utlities\LiveWallpaper\.agents\worker_e2e.
...
6. Verify layout and write a detailed handoff report in your directory (`d:\CODE\Utlities\LiveWallpaper\.agents\worker_e2e\handoff.md`).
